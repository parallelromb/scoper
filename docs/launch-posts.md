...
So I built Scoper — an open-source AI system that does it all with 9 specialized AI agents working in a visual pipeline:
...
I open-sourced Scoper — a multi-agent AI system that estimates software projects in under 2 minutes.
...
**Tweet 1:**
I just open-sourced Scoper — a multi-agent AI system that turns project documents into complete resource estimates.

What takes enterprise teams 2-4 weeks, Scoper does in 2 minutes.

Here's how it works 🧵

**Tweet 2:**
Scoper has 9 specialized AI agents, each with a "soul" (YAML-defined personality, expertise, and tools):
...
**Title:** Show HN: Scoper – Open-source multi-agent AI for software project estimation

**Body:**

Hi HN,

I built Scoper to solve a problem I kept seeing at work: software teams spending 2-4 weeks estimating projects by manually reading BRDs, cross-referencing historical data, and building spreadsheets.

Scoper runs 9 specialized AI agents in a visual drag-and-drop pipeline. Upload a document, pick a workflow template (or build your own), and get a complete estimate — phases, effort hours, costs, resources, risks, and schedule.
